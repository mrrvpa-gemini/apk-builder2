...
class _HomeAnimePageState extends State<HomeAnimePage> {
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(color: deepViolet.withOpacity(0.2), blurRadius: 15, offset: const Offset(0, 5)),
                ],
              ),
              child: Row(
                children: [
                  ...
                  Icon(Icons.movie_filter_rounded, color: accentViolet, size: 40),
                ],
              ),
            ),
            ...
            Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: [BoxShadow(color: mainViolet.withOpacity(0.1), blurRadius: 10)],
                ),
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    filled: true,
                    fillColor: cardBlack,
                    enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(15), borderSide: BorderSide(color: mainViolet.withOpacity(0.3))),
                    focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(15), borderSide: BorderSide(color: accentViolet, width: 1.5)),
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(20),
                        border: Border.all(color: isActive ? accentViolet : Colors.white24),
                        boxShadow: isActive ? [BoxShadow(color: deepViolet, blurRadius: 8)] : [],
                      ),
                      child: Text(
                        cat,
                        style: TextStyle(
              ...
              if (anime.score != null)
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(color: deepViolet.withOpacity(0.8), borderRadius: BorderRadius.circular(10), border: Border.all(color: accentViolet.withOpacity(0.5))),
                    child: Row(
                      children: [
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("${anime.type ?? 'TV'} • ${anime.year ?? '?'}", style: TextStyle(color: accentViolet, fontSize: 10)),
                  ],
                ),
              ),
            ],
  ...
  Widget _buildShimmerGrid() {
    return Shimmer.fromColors(
      baseColor: cardBlack,
      highlightColor: deepViolet.withOpacity(0.2),
                        ...
                        Wrap(
                          ...
                          children: widget.anime.genres.take(3).map((g) => 
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: deepViolet.withOpacity(0.3), 
                                borderRadius: BorderRadius.circular(5),
                                border: Border.all(color: mainViolet)
                              ),
                    ...
                    child: ElevatedButton(
                      ...
                      child: Ink(
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(15),
                          boxShadow: [
                            BoxShadow(color: mainViolet.withOpacity(0.5), blurRadius: 10, offset: const Offset(0, 4))
                          ]
                        ),
                        child: Container(
...
class AnimeStreamPage extends StatefulWidget {
  final Anime anime;
  const AnimeStreamPage({Key? key, required this.anime}) : super(key: key);
...
class _AnimeStreamPageState extends State<AnimeStreamPage> {
                        ...
                        return ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            ...
                            shape: RoundedRectangleBorder(
                              ...
                              side: BorderSide(color: isSelected ? accentViolet : Colors.white24)
                            ),
                          ),
                          onPressed: () {
  ...
  Widget _statItem(IconData icon, String label) {
    return Column(
      children: [
        Icon(icon, color: accentViolet, size: 20),
